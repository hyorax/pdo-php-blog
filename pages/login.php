    ...
    if (!empty($_POST['userInput']) && !empty($_POST['passwordInput'])) {
        ...
        if ($queryLogin) {
            if ($password === $queryLogin['user_password']) {
                ...
                header("Location: http://localhost/blog/pages/login.php?hata=2");
            }
        } else {
            header("Location: http://localhost/blog/pages/login.php?hata=2");
        }
    } else {
        header("Location: http://localhost/blog/pages/login.php?hata=1");
    }
}
    ...
    <div class="sectionDiv">
        <div class="sectionPost sectionLoginPost">
            ...
            <form method="POST" action="login.php">
                ...
                <p>ana sayfaya dönmek için <a href="http://localhost/blog/">tıklayın</a></p>
            </form>
